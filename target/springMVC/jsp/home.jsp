  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container mt-4">
        <div class="search-box">
            <form action="<c:url value='/'/>" method="get" class="row g-3">
                <div class="col-md-4">
                    <input type="text" name="search" class="form-control" placeholder="Rechercher un livre..." value="${param.search}">
                </div>
                <div class="col-md-2">
                    <input type="number" name="age_minimum" class="form-control" placeholder="Âge minimum" value="${param.age_minimum}">
                </div>
                <div class="col-md-2">
                    <input type="number" name="annee_publication" class="form-control" placeholder="Année de publication" value="${param.annee_publication}">
                </div>
                <div class="col-md-2">
                    <button type="submit" class="btn btn-primary w-100">Filtrer</button>
                </div>
                <div class="col-md-2">
                    <a href="<c:url value='/'/>" class="btn btn-secondary w-100">Réinitialiser</a>
                </div>
            </form>
        </div>
